...
export const $boilerParts =
    boilerParts.createStore<IBoilerParts>({} as IBoilerParts)
...
export const $boilerManufacturers = boilerParts
    ...
    .on(updateBoilerManufacturer, (state, payload) => {
        return [...updateManufacturer(state, payload.id as string, {checked: payload.checked})]
    })
